...
<head>
    ...
    <!-- Custom styles for this template -->
<link href="../resources/views/directory/blog.css" rel="stylesheet">
</head>
<body>
<div class="container">
    <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
            ...
            <div class="col-4 text-center">
                <a class="blog-header-logo text-dark" href="<?php echo route('home') ?>">Laravel</a>
            </div>
    ...
    <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex justify-content-between">
            <a class="p-2 text-muted" href="<?php echo route('test_page') ?>">Test_page</a>
            <a class="p-2 text-muted" href="<?php echo route('articles') ?>">Articles</a>
            <a class="p-2 text-muted" href="<?php echo route('article', ['page'=> 10]) ?>">Article</a>
            <a class="p-2 text-muted" href="<?php echo route('about') ?>">About</a>
        ...
        <div class="col-md-6">
            <div
                ...
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <h3 class="mb-0"><?php echo $title3 ?></h3>
